...
ctltoreg(enum control ctl, const struct param *p)
{
	...
	case ROOMEQ_DELAY:            reg = 0x3400; goto roomeq;
	case ROOMEQ:                  reg = 0x3401; goto roomeq;
	case ROOMEQ_BAND1TYPE:        reg = 0x3402; goto roomeq;
	case ROOMEQ_BAND1GAIN:        reg = 0x3403; goto roomeq;
	case ROOMEQ_BAND1FREQ:        reg = 0x3404; goto roomeq;
	case ROOMEQ_BAND1Q:           reg = 0x3405; goto roomeq;
	case ROOMEQ_BAND2GAIN:        reg = 0x3406; goto roomeq;
	case ROOMEQ_BAND2FREQ:        reg = 0x3407; goto roomeq;
	case ROOMEQ_BAND2Q:           reg = 0x3408; goto roomeq;
	case ROOMEQ_BAND3GAIN:        reg = 0x3409; goto roomeq;
	case ROOMEQ_BAND3FREQ:        reg = 0x340A; goto roomeq;
	case ROOMEQ_BAND3Q:           reg = 0x340B; goto roomeq;
	case ROOMEQ_BAND4GAIN:        reg = 0x340C; goto roomeq;
	case ROOMEQ_BAND4FREQ:        reg = 0x340D; goto roomeq;
	case ROOMEQ_BAND4Q:           reg = 0x340E; goto roomeq;
	case ROOMEQ_BAND5GAIN:        reg = 0x340F; goto roomeq;
	case ROOMEQ_BAND5FREQ:        reg = 0x3410; goto roomeq;
	case ROOMEQ_BAND5Q:           reg = 0x3411; goto roomeq;
	case ROOMEQ_BAND6GAIN:        reg = 0x3412; goto roomeq;
	case ROOMEQ_BAND6FREQ:        reg = 0x3413; goto roomeq;
	case ROOMEQ_BAND6Q:           reg = 0x3414; goto roomeq;
	case ROOMEQ_BAND7GAIN:        reg = 0x3415; goto roomeq;
	case ROOMEQ_BAND7FREQ:        reg = 0x3416; goto roomeq;
	case ROOMEQ_BAND7Q:           reg = 0x3417; goto roomeq;
	case ROOMEQ_BAND8TYPE:        reg = 0x3418; goto roomeq;
	case ROOMEQ_BAND8GAIN:        reg = 0x3419; goto roomeq;
	case ROOMEQ_BAND8FREQ:        reg = 0x341A; goto roomeq;
	case ROOMEQ_BAND8Q:           reg = 0x341B; goto roomeq;
	case ROOMEQ_BAND9TYPE:        reg = 0x341C; goto roomeq;
	case ROOMEQ_BAND9GAIN:        reg = 0x341D; goto roomeq;
	case ROOMEQ_BAND9FREQ:        reg = 0x341E; goto roomeq;
	case ROOMEQ_BAND9Q:           reg = 0x341F; goto roomeq;
